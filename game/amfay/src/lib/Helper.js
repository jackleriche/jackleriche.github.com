(function (window) {
    ...
    */
    Helper.makeBitmapImage = function (name, pos, alpha, doReg, customSS) {
        ...
        if(BitmapImage.currentAnimation !== name) {
    ...
    */
    ...
    /*
     *  name:           isNum
     *  description:    check to see if the param is type of number
     *  param:          num:num
     *  return:         boolen
     */
    Helper.isNum    = function(num) {
     ...
     */
     ...
     /*
     *	Name:			allValuesMatch
     *	Description:	Array Proto to check value of array are the same and return true/false
     *	Returns:		Bool
     *  Usage:          ArrayToCheck.allValuesMatch();
     */
     Array.prototype.allValuesMatch = function() {
