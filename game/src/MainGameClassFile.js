function init() {
	...
	var spriteSheet = new createjs.SpriteSheet(data);
  	...
  	var legendClip = new createjs.Bitmap('http://jackleriche.com/game/src/imports/img/legend_prizes.png');
  	legendClip.x = 632;
  	legendClip.y = 65;
  	stage.addChild(legendClip);
	
  	var legendBonusClip = new createjs.Bitmap('http://jackleriche.com/game/src/imports/img/bonusLegend.png');
  	legendBonusClip.x = 632;
  	legendBonusClip.y = 390;
  	stage.addChild(legendBonusClip);
	
  	var caveatClip = new createjs.Bitmap('http://jackleriche.com/game/src/imports/img/caveat.png');
  	caveatClip.x = 0;
  	caveatClip.y = 438;
 	...
 	var diceClip = new createjs.Bitmap('http://jackleriche.com/game/src/imports/img/dice.png');
