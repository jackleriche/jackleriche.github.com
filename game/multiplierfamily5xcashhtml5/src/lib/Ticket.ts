...
/*  Error codes
    ...
    mIWGd00010 - not valid symbol number between 10 and 40 or 5
    ...
    mIWGd00026 - tier should have a multiplier value
    mIWGd00027 - tier should not have a multiplier value
    mIWGd00028 - too many winning numbers and not enough symbols
    mIWGd00029 - matching symbols do not match amount of winners on the ticket
 */
...
module com.camelot.iwg {
    ...
    export class Ticket {
        ...
        private _errorCheck(): void {
            ...
            for (var i = 0; i < this._symbolNums.length; i++) {
                var t = this._symbolNums[i],
                    ...
                    // if symbol number is between 10-40 or 5
                    if (t > 10 && t < 41) {
        ...
        /*
         *  name:           _checkArrayForValue()
         *  description:    checks the array for the value passed in
         *  params:         array: any, num, any
         *  returns:        null
         */
        private _checkArrayForValue(array:any, num:any): void {
            for (var i = 0; i < array.length; i++) {
                if (array[i] === num){
                    this._count++;
                }
