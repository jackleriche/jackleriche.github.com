...
(function (BOOM) {
    var ChanceAmountText = (function (_super) {
        ...
        function ChanceAmountText() {
            ...
            this._amountText = this.game.make.sprite(0, 0, "masterSS", "main_500");
...
(function (BOOM) {
    var MainGameGroup = (function (_super) {
        ...
        function MainGameGroup() {
            ...
            this._logoAmount = this.game.make.sprite(0, -473, "masterSS", "logo_500");
...
(function (BOOM) {
    var SplashGroup = (function (_super) {
        ...
        function SplashGroup() {
            ...
            this._topprizes = this.game.make.sprite(this.game.width / 2, 768, "masterSS", "splash_500_top_prizes");
