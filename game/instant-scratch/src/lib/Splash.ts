...
module com.camelot.iwg {
	...
	export class Splash extends Scene {
        ...
        private _games: Array<ClickableGameObject>  = [];
        ...
        /*
		 *	name:			_initGames
		 *	description:	creates a gameobject for each game preview that the player can select
		 *	params:			null
		 * 	returns:		null
		 */
        private _initGames(): void {
            // set the names of the games to preview
            var self = this;
            var frameName = [
                'honeymoney',
                'cloudNine',
            ...
            // set the location of each preview
            var framePosition = [
                [466,105],
                [678,105],
                [466,256],
            ...
            // setup the previews for the games
            for (var i = 0; i < frameName.length; i++) {
                
                var game        = frameName[i];
                var position    = framePosition[i];
                
                // create a alpha'd clickable GO above the dispenser
                ...
                gameClick.setAction('click', function(gameClick){
                    ...
                    // remove the animation on the monitor
                    TweenMax.delayedCall( 2, () => {
                        Helper.getScene('monitorScene').destroy();
                    })
        ...
        /**
         *  name:           _setupScreen();
         *  description:    setup the monitor
         *  params:         null
         *  return:         null
         */
        private _setupScreen(): void {
        ...
        private _animateLogo(): void {
            ...
            // CHOOSE A SCRATCHCARD TO PLAY WIN UP TOGREEN TENTHOUSAND
