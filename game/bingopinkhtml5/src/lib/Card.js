        ...
        (function (iwg) {
            ...
            var Card = (function (_super) {
                ...
                Card.prototype._setupLayout = function () {
                    ...
                    var legendCornerGameObject = new iwg.GameObject(this.getName() + '-legend-corner', { w: 190, h: 20 }, 1, this);
                    ...
                    var legendColumnGameObject = new iwg.GameObject(this.getName() + '-legend-column', { w: 180, h: 20 }, 1, this);
                    ...
                    var legendRowGameObject = new iwg.GameObject(this.getName() + '-legend-row', { w: 180, h: 20 }, 1, this);
                    ...
                    var legendDiagonalGameObject = new iwg.GameObject(this.getName() + '-legend-diagonal', { w: 180, h: 20 }, 1, this);
