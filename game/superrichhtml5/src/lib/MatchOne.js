(function (window) {
    ...
    var IWGInit,
        ...
        function setupLayout(self) {
            ...
            var game1WinningSymbolText = Helper.makeBitmapImage(self.getWinningTab(), {
                x: 110,
                y: self.getY() + 10
            }),
                game1YourSymbol = Helper.makeBitmapImage(self.getYourTab(), {
                    x: 480,
                    y: self.getY() + 10
                }),
                game1Div = Helper.makeBitmapImage('game1and2_divs', {
                    x: 242,
                    y: self.getY() + 34
                });
        ...
        function setupAssets(self) {
            ...
            var gameContainer = new createjs.Container(),
                ...
                clickPrizeArea = new createjs.Container(),
                gameBG = Helper.makeBitmapImage("box_long", {
                    x: 0,
                    y: 0
                }, 1),
                gameInfo = Helper.makeBitmapImage(self.getInfo(), {
                    x: 45,
                    y: 210
                }, 1),
                winningContainer = new createjs.Container(),
                winningSymbol = Helper.makeBitmapImage(self.getWinningSymbol(), {
                    x: 0,
                    y: 0
                }),
                winningSymbolReveal = Helper.makeBitmapImage(sortWinningIcon(self), {
                    x: 0,
                    y: 0
                }, 0),
                winningMask = new createjs.Shape(),
                shimmer = Helper.makeShimmer(maskWinningSymbol, {
                    x: -70,
                    y: 720
                }, {
                    startX: -190,
            ...
            clickPrizeArea.name = "clickPrizeArea";
            ...
            winningContainer.addChild(winningSymbolReveal, clickPrizeContainer, maskContainer, clickPrizeArea);

            clickPrizeArea.hitArea = clickPrizeContainer;

            var winningSymbolFunctions = {
                "reveal": gameReveal
            }
            var winningSymbolAsset = new GameAsset(winningContainer, {}, winningSymbolFunctions);
            winningSymbolAsset.name = "gameAsset";

            clickPrizeArea.on("click", function (ev) {
                // start click
                Helper.stopPrompt();
                R.clickCount++;
            ...
            for (var i = 0; i < 4; i++) {
                ...
                var container = new createjs.Container(),
                    ...
                    clicky = new createjs.Container(),
                    winHighlight = Helper.makeBitmapImage(highlight, {
                        x: 0,
                        y: 8
                    }, 0),
                    icon = Helper.makeBitmapImage(self.getIcon(), {
                        x: 71,
                        y: 71
                    }),
                    iconMask = new createjs.Shape(),
                    shimmer = Helper.makeShimmer(maskYourSymbol, {
                        x: 0,
                        y: 790
                    }, {
                        startX: -100,
                    ...
                    shimmer2 = Helper.makeShimmer(R.prize, {
                        x: 10,
                        y: 900
                    }, {
                        startX: -120,
                    ...
                    iconReveal = Helper.makeBitmapImage(data[0], {
                        x: 71,
                        y: 71
                    }, 0),
                    prize = Helper.makeBitmapImage('word_prize', {
                        x: 75,
                        y: 137
                    }),
                    prizeMask = new createjs.Shape(),
                    prizeAmount = Helper.makeBitmapImage(data[1], {
                        x: 75,
                        y: 138
                    }, 0);
                ...
                container.addChild(winHighlight, iconReveal, prizeAmount, clickContainer, maskContainer, clicky);
                switch (i) {
                case 0:
                    container.x = 194;
                    break;
                ...
                clicky.on("click", function (ev) {

                    Helper.stopPrompt();
                    R.clickCount++;
                    var obj = ev.currentTarget;

                    var clickContainer = obj.parent.getChildByName('clickContainer');

                    if (clickContainer.isRevealed === false) {
                        clickContainer.isRevealed = true;
                        if (clickContainer.name === "shimmer") {
                            return false;
                        }
                        ...
                        if (gameAssetsArray[obj.num].getIsRevealed() == false) {
                            ...
                            // remove maskContainer
                            var clickContainer = container.getChildByName('clickContainer');
        ...
        function sortTurnData(d, number) {
            ...
            if (typeof (turnData) === "object") {
                ...
                core.IWG.ame('error', {
                    mess: ['turnData in game type "matchOne" could not be recognised']
                });
            }
        ...
        function gameReveal() {
            ...
            if (this.getContainer()) {
                ...
                for (var i = 0; i <= 5; i++) {
                    var shiner = Helper.makeBitmapImage("shiner", {
                        x: clone.x,
                        y: clone.y
                    }, 1);
                ...
                if (prize) {
                    TweenLite.to(prize, 0.3, {
                        delay: 0.35,
                        scaleY: 0,
                        scaleX: 0
                    });
                    TweenLite.to(prizeAmount, 0.3, {
                        delay: 0.35,
                        alpha: 1,
                        onStart: function () {
                            createjs.Sound.play("Pop");
                ...
                core.IWG.ame('error', {
                    mess: ['couldnt get icon Container - error code 01a1']
                });
            }
