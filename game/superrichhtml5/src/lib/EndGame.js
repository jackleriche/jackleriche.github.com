    ...
    var IWGInit,
        ...
        function setupLayout(self) {
            ...
            endGameButton.addEventListener('click', function () {
                top.location.href = "http://www.sideplay.com/portfolio/game/44/Super%20Rich";
            });
            ...
            if (core.IWG.ame('get', {
                ...
                if (ticket.instance.getIsWinner() === '1') {
                    ...
                    endGameTitle = Helper.makeBitmapImage('endgame_congratulations', {
                        x: 160,
                        y: 35
                    }, 1);
                    endGameMessageText = Helper.makeBitmapImage('endgame_youhavewon', {
                        x: 90,
                        y: 0
                    }, 1);
                    if (bank === 1208000) {
