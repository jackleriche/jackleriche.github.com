        ...
        (function (iwg) {
            ...
            var Splash = (function (_super) {
                ...
                Splash.prototype._initSplash = function () {
                    ...
                    var flareName = ['flareSplash', 'flareSplash1'];
                    for (var i = 0; i < flareData.length; i++) {
                        var position = flareData[i];
                        var name = flareName[i];
                        var flare = new GAMEOBJECT("flare" + i, { w: 120, h: 120 }, 6, this);
                        flare.addBitmap({
                            name: 'flare',
                            pos: {
                                x: 0,
                        ...
                        flare.setRotation(rotation);
                        flare.setPosition({
                            x: position[0],
                            y: position[1]
                        });
                        flare.active = true;
                        flare.getBitmap('flare').gotoAndPlay(name);
                        rotation += 75;
                    }
                    var shinerData = [
                        [378, 0],
