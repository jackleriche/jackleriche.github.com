    ...
    (function (camelot) {
        ...
        (function (iwg) {
            ...
            var GameObject = (function () {
                ...
                GameObject.prototype.setParent = function (go) {
                    this._rParent = go;
                    go.addChild(this);
                };
                ...
                GameObject.prototype.addChild = function (go) {
                    if (go.getParent().getName() === this._name) {
                        this._rChildren.push(go);
                    }
                };
                GameObject.prototype.getChild = function (name) {
                    if (this._rChildren.length > 0) {
                        for (var i = 0; i < this._rChildren.length; i++) {
                            var element = this._rChildren[i];
                            if (element.getName() === name) {
                                return element;
                            }
                        }
                    }
                    console.warn('cannot find child: ' + name + ' in GameObject ' + this.getName());
                };
                GameObject.prototype.getChildren = function () {
                    return this._rChildren;
                };
