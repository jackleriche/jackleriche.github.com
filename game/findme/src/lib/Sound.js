(function (window) {
    ...
    var IWGInit,
        ...
        Sound = function (name) {
            ...
            var _instance       = this,
                ...
                _soundOn        = function() {
                    ...
                    _stage.getChildByName('soundButton').gotoAndStop('icon_sound_on');
                    _stage.update();                      
                },
                _soundOff       = function() {
                    _sound = false;
                    ...
                    _stage.getChildByName('soundButton').gotoAndStop('icon_sound_off');
                    _stage.update();                    
                },
                _subscribe      = function() {
        ...
        function setupButton() {
            ...
            var soundButton           = Helper.makeBitmapImage("icon_sound_on", {x:29, y:29}, 1, true, MasterSS);
