...
module com.camelot.iwg {
	...
	export class Card extends Scene  {
		...
		private _setupLayout() : void { 
			...
			var legendCornerGameObject = new GameObject(this.getName() +'-legend-corner', {w: 190, h: 16}, 1, this);
			...
			var legendColumnGameObject = new GameObject(this.getName() +'-legend-column', {w: 180, h: 18}, 1, this);
			...
			var legendRowGameObject = new GameObject(this.getName() +'-legend-row', {w: 180, h: 15}, 1, this);
			...
			var legendDiagonalGameObject = new GameObject(this.getName() +'-legend-diagonal', {w: 180, h: 18}, 1, this);
