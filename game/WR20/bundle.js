...
/***/ "./node_modules/zfont/dist/zfont.es.js":
/*!*********************************************!*\
  !*** ./node_modules/zfont/dist/zfont.es.js ***!
  \*********************************************/
...
/* harmony import */ var zfont__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! zfont */ "./node_modules/zfont/dist/zfont.es.js");


window.onload = function () {
    zfont__WEBPACK_IMPORTED_MODULE_1__["default"].init(zdog__WEBPACK_IMPORTED_MODULE_0__);
    var isSpinning = true;
    var illo = new zdog__WEBPACK_IMPORTED_MODULE_0__["Illustration"]({
        element: '.zdog-canvas',
        zoom: 1,
        dragRotate: true,
    ...
    var heart = new zdog__WEBPACK_IMPORTED_MODULE_0__["Group"]({
        addTo: illo,
        translate: { z: 30 },
    });
    var heartBack = new zdog__WEBPACK_IMPORTED_MODULE_0__["Group"]({
        addTo: illo,
        translate: { z: 1 },
    });
    var rect = new zdog__WEBPACK_IMPORTED_MODULE_0__["Rect"]({
        addTo: heart,
        width: 50,
        height: 50,
        color: '#009AA7',
    ...
    var leftHeart = new zdog__WEBPACK_IMPORTED_MODULE_0__["Ellipse"]({
        addTo: heart,
        width: 50,
        height: 50,
        color: '#009AA7',
    ...
    var topHeart = new zdog__WEBPACK_IMPORTED_MODULE_0__["Ellipse"]({
        addTo: heart,
        width: 50,
        height: 50,
        color: '#009AA7',
    ...
    var myFont = new zdog__WEBPACK_IMPORTED_MODULE_0__["Font"]({
        src: './assets/font/Poppins.ttf'
    });
    // font
    var font = new zdog__WEBPACK_IMPORTED_MODULE_0__["Text"]({
        addTo: heart,
        font: myFont,
        fill: true,
        value: '20',
        ...
        color: '#fff',
        translate: { x: -22, y: 22 },
        rotate: { z: -zdog__WEBPACK_IMPORTED_MODULE_0__["TAU"] / 8 }
    });
    var smallFont = new zdog__WEBPACK_IMPORTED_MODULE_0__["Text"]({
        addTo: heart,
        font: myFont,
        fill: true,
        value: 'Years',
    ...
    zdog__WEBPACK_IMPORTED_MODULE_0__["waitForFonts"]().then(function () {
