...
module com.camelot.iwg {
        ...
        */
         ...
         *  description:    will perform a loop untill it returns a random number that is not in th enumbers selected
         *  params:         null   
         *  returns:        null
         */
        private _getRandomNumber(): void {
