...
module com.camelot.iwg {
    ...
    export class GameObject {
         ...
         *  return:         position      
         */
        public setTicketLabel(ticketLabel: any): void {
        ...
        /*
         *  name:           updateBitmap()
         *  description:    updates a bitmap in the gameObject
         *  params:         bitmap: string, frame: string
         *  returns:        bool
         */
        public updateBitmap( bitmap: string, frame: string ): boolean {
            
            try {
                if (this._stage.getChildByName(bitmap) ) {
                    var b: any = this._stage.getChildByName(bitmap);
                    b.gotoAndStop(frame);
                    this._stage.update();
                }
            } catch (err) {
                console.warn('no bitmap named ' + bitmap + ' in ' + this._name);
                console.warn(err);
                return false;
            }; 
        ...
        public addAnimation(animationName: string): void {
            ...
            if (!this._animation.hasOwnProperty(animationName)) {
                ...
                console.warn('gameObject: ' + this.getName() + ' already has animation: ' + animationName  + 'in _animation object');
            };
        ...
        /*
         *  name:           killAnimation
         *  description:    kills an animation and clears it from the animaton spot
         *  params:     	animationName: string
         *  return:         null      
         */
        public killAnimation(animationName: string): void {
            
            // see if anim is in _animation
            try {
                if (this._animation.hasOwnProperty(animationName)) {
        ...
        /*
         *  name:           clone()
         *  description:    clone the gameObject 
         *  params:     	name: string;
         *  return:         null      
         */
