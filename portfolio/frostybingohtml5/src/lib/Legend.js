...
(function (com) {
    ...
    (function (camelot) {
        var iwg;
        (function (iwg) {
            var CAMELOT = com.camelot, CORE = CAMELOT.core, IWG = CAMELOT.iwg, QUEUEMANGER = IWG.QueueManager, GAMEOBJECT = IWG.GameObject, ANIMATION = IWG.Animation, SPRITESHEETS = IWG.SpriteSheets, images = CORE.iwgLoadQ.images, SYNCANIMATION = IWG.SyncAnimation, iconRef = IWG.IconRef;
            var Legend = (function () {
                function Legend() {
                    this._legendRows = [];
                    this._rows = 0;
