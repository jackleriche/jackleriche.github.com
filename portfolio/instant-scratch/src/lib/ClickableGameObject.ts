...
module com.camelot.iwg {
	...
	export class ClickableGameObject extends GameObject {
		...
		constructor(_name: string, _dimensions: any = { w: 0, h: 0 }, _zindex: number = 1, _parent: any = "scaleDiv", private _action: boolean = true ) {
		...
		private _setupButtonConfig(): void {
			...
			this.setAction('rollover', () => {
				...
				if ( this._action && CORE.IWG.ame('get','IS_DESKTOP')) {
