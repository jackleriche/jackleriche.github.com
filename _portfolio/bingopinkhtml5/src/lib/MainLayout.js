        ...
        (function (iwg) {
            ...
            var MainLayout = (function () {
                ...
                MainLayout.prototype._mainGameSetup = function () {
                    ...
                    card2.setScale(0);
                    card2.intro(0.6);
                    var card3 = new CARD("card3", [5, 10, 50, 10000]);
                    card3.setZindex(4);
                    card3.setPosition({
                        x: 10,
                        y: 280
                    ...
                    startBall.addAnimation('rollOver');
                    startBall.addAnimation('rollOut');
                    startBall.addAnimation('pulse');
                    startBall.setAnimation("ballPop", "ballPopStart");
                    startBall.setAnimation("ballRollOff", "ballRollOffStart");
                    startBall.setAnimation('rollOver', 'rollover', 0.2, 0, 1.3);
                    startBall.setAnimation('rollOut', 'rollout');
                    startBall.setAnimation('pulse', 'pulseStartBall');
                    startBall.setEnabled(false);
                    startBall.setAction('click', function () {
                        if (GLOBAL.getInstance().getFromGlobal('gameState') === 'splash') {
                            startBall.setScale(1.1, 1.1);
