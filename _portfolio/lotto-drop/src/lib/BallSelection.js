        ...
        (function (iwg) {
            ...
            var BallSelection = (function (_super) {
                ...
                BallSelection.prototype._initBallSelection = function () {
                    var selectedBalls = new CLICKABLEGAMEOBJECT('selectedBalls', { w: 500, h: 100 }, 2, this), balls = new CLICKABLEGAMEOBJECT('balls', { w: 800, h: 470 }, 2, this);
                ...
                BallSelection.prototype._ballSelected = function (ball) {
                    if (!ball.selected) {
                        if (!GLOBAL.getInstance().getFromGlobal('maxSelected')) {
                            createjs.Sound.play("chooseBall");
                            ball.selected = true;
                ...
                BallSelection.prototype._updateMessage = function (num) {
                    var choose = this.getChildByName('balls'), chooseBitmap = this.getChildByName('balls').getBitmap('choose6');
                    switch (num) {
                        case 0:
                ...
                BallSelection.prototype._maxSelected = function () {
                    var _this = this;
                    ...
                    timeline.to(choose6numbers, 0.2, { alpha: 0, onComplete: function () {
                            _this.getChildByName('balls').setEnabled(true);
                            _this._button.animate('fadeIn');
                ...
                BallSelection.prototype._removeNextButton = function () {
                    ...
                    timeline.call(function () {
                        _this.getChildByName('balls').setEnabled(false);
                        _this._button.animationTimeLine.kill();
                        _this._button.animate('fadeOff');
                    })
                        .to(choose6numbers, 0.2, { delay: 0.2, alpha: 1, onComplete: function () {
                            _this.getChildByName('balls').setEnabled(true);
                        } });
                };
...
//# sourceMappingURL=BallSelection.js.map