    ...
    (function (camelot) {
        ...
        (function (iwg) {
            ...
            var MiniGameOne = (function (_super) {
                ...
                MiniGameOne.prototype._checkRandNum = function () {
                ...
                MiniGameOne.prototype._updatePrize = function () {
                    var gO = this.getChildByName('miniGame_prizeSymbol'), prizeBall = this.getChildByName('miniGame_prizeSymbol').getBitmap('prizeValue');
...
//# sourceMappingURL=MiniGameOne.js.map