            ...
            var EndGame = (function (_super) {
                ...
                EndGame.prototype._endGameLayout = function () {
                    ...
                    endGameButton.setAction('click', function () {
                        ...
                        top.location.href = "http://www.sideplay.com/portfolio/game/111/10x%20Cash";
                    });
                    ...
                    else if ((function (num) { return 10; }) && (num <= 99)) {
                        offset = 60;
                    }
                    else if ((function (num) { return 100; }) && (num <= 999)) {
                        offset = 55;
                    }
                    else if ((function (num) { return 1000; }) && (num <= 49999)) {
                        offset = 45;
                    }
                    else if (num === 50000) {
                        offset = 30;
                ...
                EndGame.prototype._showEndGame = function () {
                    ...
                    TweenMax.to(this.getDiv(), 1, { alpha: 1, delay: 7, y: 0, ease: Bounce.easeOut, onStart: function () {
                            self._winSound();
                            self.setZindex('11');
                            ...
                            TweenMax.to(HELPER.getGameObject('logoGame').getCanvas(), 1, { alpha: 0 });
