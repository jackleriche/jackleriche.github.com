(function (window) {
    ...
    function setupLayout(t) {
        ...
        boxHighlight.graphics.drawRoundRect(0,0,816, 333, 10);
    ...
    function setupTurnsLayout(t, turnData, itt) {
        ...
        var contXArr = [313,463,603,743,313,463,603,743];
        var contYArr = [106,106,106,106,250,250,250,250];

        var maskYAdjust = [0,0,0,0,23,23,23,23];
        var maskWAdjust = [+10,0,0,13,+10,0,0,13];
        var maskHAdjust = [1,1,1,1,-12,-12,-12,-12];
