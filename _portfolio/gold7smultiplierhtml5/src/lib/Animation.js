    ...
    (function (camelot) {
        ...
        (function (iwg) {
            ...
            var Animation = (function () {
                function Animation() {
                    this.animations = {
                        buttonPress: function (gameObject, time, delay) {
                        ...
                        spinPress: function (gameObject, time, delay) {
                            if (time === void 0) { time = 1; }
                            if (delay === void 0) { delay = 0; }
                            return function () {
                                TweenMax.to(gameObject.getCanvas(), 0.2, { onStart: function () {
                        ...
                        revealPrize: function (gameObject, time, delay) {
                            if (time === void 0) { time = 1; }
                            if (delay === void 0) { delay = 0; }
                        ...
                        winRevealPrize: function (gameObject, time, delay) {
                            if (time === void 0) { time = 1; }
                            if (delay === void 0) { delay = 0; }
                            var timeline = new TimelineMax({
                                onStart: function () {
                        ...
                        winRevealMultiplier: function (gameObject, time, delay) {
                            if (time === void 0) { time = 1; }
                            if (delay === void 0) { delay = 0; }
                            var timeline = new TimelineMax({
                                onStart: function () {
