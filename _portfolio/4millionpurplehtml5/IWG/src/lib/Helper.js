(function (window) {
    ...
    Helper.showPrompt = function (screen) {
        ...
        if (isPrompting === false) {
            ...
            var currentScreen = R.SWIPE.getCurrentScreen();
            ...
            if(currentScreen === 0){
                if(R.GAMES[2].getIsFinished() != true || R.GAMES[3].getIsFinished() != true || R.GAMES[4].getIsFinished() != true){
                    ...
                    R.FIRSTGAMEWINDOW.addChild(promptRight);

                    var leftAnimation = TweenMax.to(promptRight, 0.7, {
                        alpha: 1,
                        yoyo: true,
                        repeat: -1,
                        delay: 4
                ...
                if(R.GAMES[0].getIsFinished() != true || R.GAMES[1].getIsFinished() != true){
                    ...
                    R.SECONDGAMEWINDOW.addChild(promptLeft);

                    var rightAnimation = TweenMax.to(promptLeft, 0.7, {
                        alpha: 1,
                        yoyo: true,
                        repeat: -1,
                        delay: 4
                ...
                if(R.GAMES[4].getIsFinished() != true ){
                    ...
                    R.SECONDGAMEWINDOW.addChild( promptRight);
                ...
                if(R.GAMES[0].getIsFinished() != true || R.GAMES[1].getIsFinished() != true || R.GAMES[2].getIsFinished() != true || R.GAMES[3].getIsFinished() != true){
                    ...
                    R.THIRDGAMEWINDOW.addChild(promptLeft);
