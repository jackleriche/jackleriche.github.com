        ...
        Panel.prototype.render = function (_butsOnTop) {
            ...
            switch(this.panelType) {
                case "start":
                    ...
                    var bX = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleImage].x;
                    var bY = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleImage].y;
                    var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleImage].width;
                    var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleImage].height;
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - bWidth / 2, 440 - bHeight / 2 - this.posY, bWidth, bHeight);
                    var bX = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleHeader].x;
                    var bY = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleHeader].y;
                    var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleHeader].width;
                    var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleHeader].height;
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - bWidth / 2, 135 - bHeight / 2 - this.posY, bWidth, bHeight);
                    break;
                case "game":
                    ctx.drawImage(this.oMainBg1ImgData.img, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight);
                    var bX = this.oUiElementsImgData.oData.oAtlasData[oImageIds.inGameProfBg].x;
                    var bY = this.oUiElementsImgData.oData.oAtlasData[oImageIds.inGameProfBg].y;
                    var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.inGameProfBg].width;
                    var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.inGameProfBg].height;
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, 505 - bWidth / 2, 95 - bHeight / 2, bWidth, bHeight);
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, 505 - (bWidth / 2) * pScale, 169 - (bHeight) * pScale, bWidth * pScale, bHeight * pScale);
                    ...
                    ctx.drawImage(oQImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - bWidth / 2, 321 - bHeight / 2 - this.posY, bWidth, bHeight);
                    break;
                case "levelUp":
                    ctx.drawImage(this.oMainBg1ImgData.img, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight);
...
function createVideo() {
    ...
    var movie2play = '@vid' + currentLevel;

    if ( movie2play !== undefined ){
        // play a movie
        var videoBackground = document.createElement('div');
        videoBackground.id = 'video';
        // style background
        videoBackground.style.background = 'white';
...
function butEventHandler(_id, _oData) {
    switch(_id) {
        ...
        case "restartFromGameComplete":
            playSound("click");
            userInput.removeHitArea("exitFromGameComplete");
            userInput.removeHitArea("restartFromGameComplete");
          
            initGame();
            break;
        case "exitFromGameComplete":
            playSound("click");
            userInput.removeHitArea("exitFromGameComplete");
            userInput.removeHitArea("restartFromGameComplete");
            initStartScreen();
...
function nextQuestion() {
    ...
    if(levelNum == 0 && qCorrect == aGameData["@questionsLevel1"]) {
        
        if(aGameData["@questionsLevel2"] == undefined) {
            initGameComplete();
        } else {
            levelNum = 1;
            if ( aGameData["@questionsLevel1Video"] ){
                createVideo();
            } else {
                initLevelUp();
            }
    ...
    } else if(levelNum == 1 && qCorrect == aGameData["@questionsLevel1"] + aGameData["@questionsLevel2"]) {
        if(aGameData["@questionsLevel3"] == undefined) {
            initGameComplete();
        } else {
            levelNum = 2;
            if ( aGameData["@questionsLevel2Video"] ){
                createVideo();
            } else {
                initLevelUp();
            }
        }
    } else if(levelNum == 2 && qCorrect == aGameData["@questionsLevel1"] + aGameData["@questionsLevel2"] + aGameData["@questionsLevel3"]) {
        if(aGameData["@questionsLevel4"] == undefined) {
            initGameComplete();
        } else {
            levelNum = 3;
            if ( aGameData["@questionsLevel3Video"] ){
                createVideo();
            } else {
                initLevelUp();
            }
        }
    } else if(levelNum == 3 && qCorrect == aGameData["@questionsLevel1"] + aGameData["@questionsLevel2"] + aGameData["@questionsLevel3"] + aGameData["@questionsLevel4"]) {
        initGameComplete();
    } else {
        initQuestion();
    }
...
function loadAssets() {
    ...
    for(var i = 0; i < totalQNum; i++) {
        aImageData.push({
            id: "question" + i,
            file: "images/questions/" + (i + 1) + "_QuestionAnswer.png",
            oAtlasData: {
                id0: {
                    x: 0,
                    y: 0,
    ...
    oImageIds.exitBut = "id6";
    oImageIds.prof0 = "id0";
    oImageIds.prof1 = "id1";
    oImageIds.prof2 = "id2";
    oImageIds.prof3 = "id3";
    oImageIds.titleHeader = "id4";
    oImageIds.titleImage = "id5";
    oImageIds.inGameProfBg = "id6";
    oImageIds.clock = "id7";
    oImageIds.levelUpCongrats = "id8";
    oImageIds.levelCompleteMessage1 = "id9";
    oImageIds.levelCompleteMessage2 = "id10";
    oImageIds.levelCompleteMessage3 = "id11";
    oImageIds.score = "id12";
    oImageIds.resultSymbol1 = "id13";
    oImageIds.resultSymbol0 = "id14";
    oImageIds.butBg1 = "id15";
    oImageIds.butBg0 = "id16";
    oImageIds.butBg2 = "id17";
...
function renderMuteBut() {
    ...
    var oImgData = assetLib.getData("uiButs");
    var id = 0;
    if(muted) {
        id = 1;
    }
    var bX = oImgData.oData.oAtlasData[oImageIds["muteBut" + id]].x;
    var bY = oImgData.oData.oAtlasData[oImageIds["muteBut" + id]].y;
    var bWidth = oImgData.oData.oAtlasData[oImageIds["muteBut" + id]].width;
    var bHeight = oImgData.oData.oAtlasData[oImageIds["muteBut" + id]].height;
    ctx.drawImage(oImgData.img, bX, bY, bWidth, bHeight, 45 - bWidth / 2, 45 - bHeight / 2, bWidth, bHeight);
}
