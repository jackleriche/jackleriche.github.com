...
(function (Elements) {
    var Panel = (function () {
        function Panel(_panelType, _aButs) {
            ...
            this.oEndBg0ImgData = assetLib.getData("endBg0");
            this.oEndBg1ImgData = assetLib.getData("endBg1");
            ...
            switch(this.panelType) {
                ...
                case "game":
                    ...
                    for(var i = 0; i < num.toString().length; i++) {
                        ...
                        ctx.drawImage(this.oNumbersImgData.img, imgX, imgY, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, 92 + i * (this.numberSpace * numScale) - ((this.numberSpace * num.toString().length) / 2) * numScale, 50, this.oNumbersImgData.oData.spriteWidth * numScale, this.oNumbersImgData.oData.spriteHeight * numScale);
                    }
                    ...
                    ctx.drawImage(oQImgData.img, bX, bY, bWidth, bHeight, 50 - this.posY, 310 - bHeight / 2, bWidth, bHeight);
                    break;
                case "levelUp":
                    ctx.drawImage(this.oMainBg1ImgData.img, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight, 0, 0, this.oMainBg1ImgData.oData.spriteWidth, this.oMainBg1ImgData.oData.spriteHeight);
                ...
                case "gameComplete":
                    if(qCorrect >= aGameData["@scoreToGetCongrats"]) {
                        ctx.drawImage(this.oEndBg0ImgData.img, 0, 0, this.oEndBg0ImgData.oData.spriteWidth, this.oEndBg0ImgData.oData.spriteHeight, 0, 0, this.oEndBg0ImgData.oData.spriteWidth, this.oEndBg0ImgData.oData.spriteHeight);
                    } else {
                        ctx.drawImage(this.oEndBg1ImgData.img, 0, 0, this.oEndBg1ImgData.oData.spriteWidth, this.oEndBg1ImgData.oData.spriteHeight, 0, 0, this.oEndBg1ImgData.oData.spriteWidth, this.oEndBg1ImgData.oData.spriteHeight);
                    }
                    break;
                case "pause":
...
function butEventHandler(_id, _oData) {
    ...
    var facebookEndString = "https://www.facebook.com/sharer/sharer.php?u=http://www.wowow.co.jp/dramaw/meishi/&quote=12%E6%9C%882%E6%97%A5%28%E5%9C%9F%29%E3%82%88%E3%82%8AWOWOW%E3%81%AB%E3%81%A6%E6%94%BE%E9%80%81%E3%80%8E%E9%80%A3%E7%B6%9A%E3%83%89%E3%83%A9%E3%83%9EW+%E5%90%8D%E5%88%BA%E3%82%B2%E3%83%BC%E3%83%A0%E3%80%8F%E3%81%AE%E3%82%AF%E3%82%A4%E3%82%BA%E3%82%B2%E3%83%BC%E3%83%A0%E3%81%8C%E5%85%AC%E9%96%8B%EF%BC%81+-%E8%AC%8E%E3%81%AE%E7%94%B7%E3%81%8B%E3%82%89%E5%87%BA%E9%A1%8C%E3%81%95%E3%82%8C%E3%82%8B%E3%82%AF%E3%82%A4%E3%82%BA%E3%81%AB%E5%9B%9E%E7%AD%94%E3%81%97%E3%80%81%E8%84%B1%E5%87%BA%E3%82%92%E7%9B%AE%E6%8C%87%E3%81%9B%EF%BC%81https%3A%2F%2Fs.newscafe.ne.jp%2Ffeature%2Fmeishigame%2F+-%E3%80%8E%E9%80%A3%E7%B6%9A%E3%83%89%E3%83%A9%E3%83%9EW+%E5%90%8D%E5%88%BA%E3%82%B2%E3%83%BC%E3%83%A0%E3%80%8F%E3%81%AE%E5%85%AC%E5%BC%8F%E3%82%B5%E3%82%A4%E3%83%88%E3%81%AF%E3%81%93%E3%81%A1%E3%82%89+http%3A%2F%2Fwww.wowow.co.jp%2Fdramaw%2Fmeishi%2F";
    var twitterEndString = "https://twitter.com/intent/tweet?url=http://www.wowow.co.jp/dramaw/meishi/&text=12月2日(土)よりWOWOWにて放送『連続ドラマW 名刺ゲーム』のクイズゲームが公開！ -謎の男から出題されるクイズに回答し、脱出を目指せ！https://s.newscafe.ne.jp/feature/meishigame/ -『連続ドラマW 名刺ゲーム』の公式サイトはこちら"
    ...
    switch(_id) {
        ...
        case "linkFromGameComplete":
            ...
            var url;
            if(qCorrect >= aGameData["@scoreToGetCongrats"]) {
                url = aGameData["@successLinkURL"];
            } else {
                url = aGameData["@failLinkURL"];
            }
        ...
        case "facebookHit":
            playSound("click");
            var url = facebookEndString;
            var open = window.open( url, 'WOWOW', 'width=600,height=600' );
            if(open == null || typeof (open) == 'undefined') {
                location.href = url;
            }
            break;
        case "twitterHit":
            playSound("click");
            var url = twitterEndString;
            var open = window.open( url, 'WOWOW', 'width=600,height=300' );
            if(open == null || typeof (open) == 'undefined') {
                location.href = url;
            }
            break;
...
function loadAssets() {
    var aImageData = new Array({
        ...
        id: "endBg0",
        file: "images/endBg0.jpg"
    }, {
        id: "endBg1",
        file: "images/endBg1.jpg"
    }, {
        id: "gameData",
        file: "json/gameData.json"
    }, {
    ...
    for(var i = 0; i < totalQNum; i++) {
        ...
        aImageData.push({
            id: "question" + i,
            file: "images/questions/meishigame_QUESTION-" + numText + ".png",
            oAtlasData: {
                id0: {
                    x: 0,
                    y: 0,
    ...
    oImageIds.resultSymbol1 = "id0";
    oImageIds.resultSymbol0 = "id1";
    oImageIds.butBg1 = "id2";
    oImageIds.butBg0 = "id3";
    oImageIds.butBg2 = "id4";
